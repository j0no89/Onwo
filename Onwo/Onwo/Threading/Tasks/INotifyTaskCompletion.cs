...
namespace Onwo.Threading.Tasks
{
    ...
    public interface INotifyTaskCompletion : INotifyPropertyChanged
    {
        ...
        Task NotificationsCompleted { get; }
        /// <summary>
    ...
    public interface INotifyTaskCompletion<TResult> : INotifyTaskCompletion
    {
        ...
        new ConfiguredTaskAwaitable<TResult> ConfigureAwait(bool continueOnCapturedContext=false);
        /// <summary>
    ...
    public interface ILazyNotifyTaskCompletion : INotifyTaskCompletion
    {
        bool IsTaskCreated { get; }
        void Reset();
    }
    public interface ILazyNotifyTaskCompletion<T> : INotifyTaskCompletion<T>,ILazyNotifyTaskCompletion
    {

    }

    public interface INamedLazyTask : ILazyNotifyTaskCompletion
    {
        string Name { get; set; }
    }
    public interface INamedLazyTask<T> : ILazyNotifyTaskCompletion<T>,INamedLazyTask
    {
